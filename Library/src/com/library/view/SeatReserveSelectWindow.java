...
public class SeatReserveSelectWindow extends JFrame {
	public JButton bt_room1, bt_room2, bt_room3, bt_reserve, bt_cancel, bt_logout, bt_room1_seat1, bt_room1_seat2,
			bt_room1_seat3, bt_room1_seat4, bt_room1_seat5, bt_room1_seat6, bt_room1_seat7, bt_room1_seat8,
			bt_room1_seat9,

			bt_room2_seat1, bt_room2_seat2, bt_room2_seat3, bt_room2_seat4, bt_room2_seat5, bt_room2_seat6,
			bt_room2_seat7, bt_room2_seat8, bt_room2_seat9,

			bt_room3_seat1, bt_room3_seat2, bt_room3_seat3, bt_room3_seat4, bt_room3_seat5, bt_room3_seat6,
...
//		bt_room1_seat1.setBackground(cc);
	...
	public void change_sitcolor_room1(int sitnum) {
		if (sitnum == 1) {
			...
			bt_room1_seat2.setBackground(cc);
		} else if (sitnum == 3) {
			bt_room1_seat3.setBackground(cc);
		} else if (sitnum == 4) {
			bt_room1_seat4.setBackground(cc);
		} else if (sitnum == 5) {
			bt_room1_seat5.setBackground(cc);
		} else if (sitnum == 6) {
			bt_room1_seat6.setBackground(cc);
		} else if (sitnum == 7) {
			bt_room1_seat7.setBackground(cc);
		} else if (sitnum == 8) {
			bt_room1_seat8.setBackground(cc);
		} else if (sitnum == 9) {
			bt_room1_seat9.setBackground(cc);
		}
	}

	public void change_sitcolor_room2(int sitnum) {
		if (sitnum == 10) {
			bt_room2_seat1.setBackground(cc);
		} else if (sitnum == 11) {
			bt_room2_seat2.setBackground(cc);
		} else if (sitnum == 12) {
			bt_room2_seat3.setBackground(cc);
		} else if (sitnum == 13) {
			bt_room2_seat4.setBackground(cc);
		} else if (sitnum == 14) {
			bt_room2_seat5.setBackground(cc);
		} else if (sitnum == 15) {
			bt_room2_seat6.setBackground(cc);
		} else if (sitnum == 16) {
			bt_room2_seat7.setBackground(cc);
		} else if (sitnum == 17) {
			bt_room2_seat8.setBackground(cc);
		} else if (sitnum == 18) {
			bt_room2_seat9.setBackground(cc);
		}
	}

	public void change_sitcolor_room3(int sitnum) {
		if (sitnum == 19) {
			bt_room3_seat1.setBackground(cc);
		} else if (sitnum == 20) {
			bt_room3_seat2.setBackground(cc);
		} else if (sitnum == 21) {
			bt_room3_seat3.setBackground(cc);
		} else if (sitnum == 22) {
			bt_room3_seat4.setBackground(cc);
		} else if (sitnum == 23) {
			bt_room3_seat5.setBackground(cc);
		} else if (sitnum == 24) {
			bt_room3_seat6.setBackground(cc);
		} else if (sitnum == 25) {
			bt_room3_seat7.setBackground(cc);
		} else if (sitnum == 26) {
			bt_room3_seat8.setBackground(cc);
		} else if (sitnum == 27) {
			bt_room3_seat9.setBackground(cc);
		}
	}

	public void change_sitdefault_room1(int sitnum) {
		if (sitnum == 1) {
			bt_room1_seat1.setBackground(new JButton().getBackground());
		} else if (sitnum == 2) {
			bt_room1_seat2.setBackground(new JButton().getBackground());
		} else if (sitnum == 3) {
			bt_room1_seat3.setBackground(new JButton().getBackground());
		} else if (sitnum == 4) {
			bt_room1_seat4.setBackground(new JButton().getBackground());
		} else if (sitnum == 5) {
			bt_room1_seat5.setBackground(new JButton().getBackground());
		} else if (sitnum == 6) {
			bt_room1_seat6.setBackground(new JButton().getBackground());
		} else if (sitnum == 7) {
			bt_room1_seat7.setBackground(new JButton().getBackground());
		} else if (sitnum == 8) {
			bt_room1_seat8.setBackground(new JButton().getBackground());
		} else if (sitnum == 9) {
			bt_room1_seat9.setBackground(new JButton().getBackground());
		}
	}

	public void change_sitdefault_room2(int sitnum) {
		if (sitnum == 10) {
			bt_room2_seat1.setBackground(new JButton().getBackground());
		} else if (sitnum == 11) {
			bt_room2_seat2.setBackground(new JButton().getBackground());
		} else if (sitnum == 12) {
			bt_room2_seat3.setBackground(new JButton().getBackground());
		} else if (sitnum == 13) {
			bt_room2_seat4.setBackground(new JButton().getBackground());
		} else if (sitnum == 14) {
			bt_room2_seat5.setBackground(new JButton().getBackground());
		} else if (sitnum == 15) {
			bt_room2_seat6.setBackground(new JButton().getBackground());
		} else if (sitnum == 16) {
			bt_room2_seat7.setBackground(new JButton().getBackground());
		} else if (sitnum == 17) {
			bt_room2_seat8.setBackground(new JButton().getBackground());
		} else if (sitnum == 18) {
			bt_room2_seat9.setBackground(new JButton().getBackground());
		}
	}

	public void change_sitdefault_room3(int sitnum) {
		if (sitnum == 19) {
			bt_room3_seat1.setBackground(new JButton().getBackground());
		} else if (sitnum == 20) {
			bt_room3_seat2.setBackground(new JButton().getBackground());
		} else if (sitnum == 21) {
			bt_room3_seat3.setBackground(new JButton().getBackground());
		} else if (sitnum == 22) {
			bt_room3_seat4.setBackground(new JButton().getBackground());
		} else if (sitnum == 23) {
			bt_room3_seat5.setBackground(new JButton().getBackground());
		} else if (sitnum == 24) {
			bt_room3_seat6.setBackground(new JButton().getBackground());
		} else if (sitnum == 25) {
			bt_room3_seat7.setBackground(new JButton().getBackground());
		} else if (sitnum == 26) {
			bt_room3_seat8.setBackground(new JButton().getBackground());
		} else if (sitnum == 27) {
			bt_room3_seat9.setBackground(new JButton().getBackground());
		}
	}
